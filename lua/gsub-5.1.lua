...
function generic_gsub (func, str, pat, repl, n, cflags, eflags)
    assert(type(repl) == "string" or type(repl) == "function" or type(repl) == "table",
                ...
                if n_capt_repl == 0 then
                    ...
                    for _,v in ipairs(tb_replace) do
                        if type(v) == "number" then
                            if v == 0 then insert(tb_out, sub(str,s,e))
                            elseif t[v] then insert(tb_out, t[v])
                            end
                        else
                            insert(tb_out, v)
                        end
